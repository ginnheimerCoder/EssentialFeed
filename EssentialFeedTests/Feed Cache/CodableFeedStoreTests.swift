...
//  EssentialFeedTests
//
//  Created by David Gänshirt on 16.11.23.
//
...
protocol FeedStoreSpecs {
    ...
    func test_insert_deleiversNoErrorOnNonEmptyCache()
...
protocol FailableRetrieveFeedSpecs {
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effects to tun serially but operations finished in the wrong order")
    }
