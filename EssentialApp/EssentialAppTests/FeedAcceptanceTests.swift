...
//  EssentialAppTests
//
//  Created by David Gänshirt on 05.04.24.
//
...
class FeedAcceptanceTests: XCTestCase {
    ...
    func test_onLaunch_displaysCachedRemoteFeedWhenCustomerHasConnectivity() {
        ...
        XCTAssertEqual(offlineFeed.renderedFeedImageData(at: 0), makeFeedData())
        XCTAssertEqual(offlineFeed.renderedFeedImageData(at: 1), makeFeedData())
    }
    ...
    private func response(for url: URL) -> (Data, HTTPURLResponse) {
        ...
        return (makeData(for: url), responce)
    }
