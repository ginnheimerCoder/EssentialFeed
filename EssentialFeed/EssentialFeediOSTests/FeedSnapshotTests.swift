...
//
//  Created by David Gänshirt on 08.04.24.
//
...
class FeedSnapshotTests: XCTestCase {
    ...
    private func feedWithContent() -> [ImageStub] {
        return [
            ImageStub(
                description: "The East Side Gallery is an open-air gallery in Berlin. It consists of a series of murals painted directly on a 1,316 m ling remnant of the Berlin Wall, located nead the centre of Berlin, on Mühlenstraße in Friedrichshain-Kreuzberg. The gallery has official status as a Denkmal, or heritage-protected landmark.",
